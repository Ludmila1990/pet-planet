...
const createOrderMessage = (id) => {
  ...
  orderMessageText.textContent = `Ваш заказ оформлен номер ${id}. Вы можете забрать его завтра после 12:00`;
...
const renderCartItems = (cartItemsList, cartItems, products) => {
...
export {createOrderMessage, renderProducts, renderCartItems};
